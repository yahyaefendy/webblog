                    ...
                    <?php if ($query->num_rows != 0): ?>
                      <?php while ($row = $query->fetch_array()): ?>
                        ...
                        <div class="card mb-3">
                          ...
                          <div class="card-body">
                            <h2 class="card-title">
                              <a href="detil.php?id=<?php echo $row['idartikel']; ?>"> 
                                <?php echo $row['judul']; ?>
                              </a>
                            </h2>
                            <hr>
                            <p class="card-text"><b><?php echo $row['judul']; ?>.</b> <?php echo $limited_string; ?><a href="detil.php?id=<?php echo $row['idartikel']; ?>">....Baca Selanjutnya 
                              </a>
                            </p>
                            <p class="card-text">
